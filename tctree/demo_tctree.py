...
from tctree import TemporalCutsQualityMeasure, BestTemporalCutSelectionMethod, TemporalCutsDecisionTreeClassifier
...
# Train TC-Tree classifier
tree_classifier = TemporalCutsDecisionTreeClassifier()
tree_classifier.fit(data_tr, alpha_start=alpha_start, alpha_step=alpha_step, alpha_step_count=alpha_step_count,
...
labels_pred = tree_classifier.predict(data_tst)
print(labels_pred)
proba_pred = tree_classifier.predict_proba(data_tst)
